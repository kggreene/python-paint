...
# Find white components, sort by size. Biggest is background, second biggest
# is flower center, others are petals
...
for lbl in whiteLabels:
    if lbl != backgroundLabel and lbl != bodyLabel:
